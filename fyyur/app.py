...
def show_venue(venue_id):
  ...
  data={
    ...
    "st_description": venue.st_description,
...
def create_venue_submission():
  ...
  try: 
    ...
    venue = Venue(name=name, city=city, state=state, address=address, phone=phone, genres=genres, facebook_link=facebook_link, image_link=image_link, website_link=website_link, seeking_talent=seeking_talent, st_description=st_description)
...
def show_artist(artist_id):
  ...
  data={
    ...
    "sv_description": artist.sv_description,
    "past_shows": past_shows,
    "upcoming_shows": upcoming_shows,
    "past_shows_count": len(past_shows),
    "upcoming_shows_count": len(upcoming_shows)
...
def edit_artist(artist_id):
  ...
  # TODO: populate form with values from venue with ID <venue_id>, changed it to artist_id
  form = ArtistForm()
  artist = Artist.query.get(artist_id)
  ...
  if artist: 
    ...
    form.sv_description.data = artist.sv_description
...
def edit_venue_submission(venue_id):
  ...
  try: 
    ...
    venue.st_description = request.form['st_description']
...
def create_artist_submission():
  ...
  try: 
    ...
    sv_description = request.form['sv_description']

    artist = Artist(name=name, city=city, state=state, phone=phone, genres=genres, facebook_link=facebook_link, image_link=image_link, website_link=website_link, seeking_venue=seeking_venue, sv_description=sv_description)
